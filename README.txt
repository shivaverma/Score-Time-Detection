...
This software detect the score and time written on the top left corner in the football match. For now it supports only
one pertivular format. Following is the information of each component of the project.
...
--------------------------------------------------------------------------------------------
AWS website link to the project: http://18.222.93.36:8080/
Images Dataset link: https://drive.google.com/open?id=1lpH-8w5751zdTxRo4271-eTUlys8viSr
